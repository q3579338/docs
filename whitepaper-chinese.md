...
##摘要
挂钩资产的令牌通常可用于付款，资金管理，交换和财富保存。挂钩资产的代币网络定义了一组挂钩令牌，这些令牌代表了诸如货币，贵金属，其他加密货币资产，商品等一系列真实市场的资产。例如，与美元挂钩的令牌可用于购买美元计价的货物，并且买卖双方可以放心，而且价格将非常接近于等值的美元。对于持有加密货币资产的公司，当加密货币市场低迷时，将这些资产的一部分转换成与美元挂钩的资产能力可以帮助保留资本。对于仅处理加密货币的交易所而言，通过使用与现实世界货币挂钩的令牌来锚定美元或欧元，而不必与传统的银行系统交易来持有这些资产。与其他资产（例如贵金属）挂钩的令牌允许用户在加密货币交易所中持有黄金或白银的等价物。与加密货币挂钩可以简化采用比特币等加密货币计价的交易，而不会存在那些区块链上可能存在的交易限制。将价值与其他商品或资产挂钩是可能的，从而扩大了挂钩令牌网络的用例。本文将更详细地描述Pegged令牌网络，并介绍了这种基于公正通的网络的实现和设计。
